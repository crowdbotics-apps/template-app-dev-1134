...
export const input = props => {
	...
	return (
		<View>
			<Item>
				{props.type === 'email' ? (
					<Icon name="ios-mail" style={{ color: commonColor.lightThemePlaceholder }} />
				) : (
					<Icon name="ios-lock" style={{ color: commonColor.lightThemePlaceholder }} />
				)}
				<Input {...input} {...props} />
			</Item>
	...
	render() {
		return (
			<View>
				...
				<Button transparent style={{ left: deviceWidth - 200 }} onPress={this.forgotPassword.bind(this)}>
